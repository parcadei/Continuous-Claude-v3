...
def get_connection_string() -> str:
    ...
    1. OPC_POSTGRES_URL - allows override when DATABASE_URL is set by another project
    2. AGENTICA_POSTGRES_URL - legacy name
    3. DATABASE_URL - standard name, generated by wizard
